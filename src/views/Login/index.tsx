    ...
    return (
        <FormContainer>
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                <FormHeadingSection>
                    <IconButton type="button" variant="facebook" text="Continue with Facebook" icon={<FaFacebook />} />
                    <IconButton type="button" variant="apple" text="Continue with Apple" icon={<FaApple />} />
                    <IconButton type="button" variant="default" text="Continue with Google" icon={<FaGoogle />} />
